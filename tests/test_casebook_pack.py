"""Regression checks for the copper-plat-ci-gate casebook."""
...
from casebook.harness import assert_expected, copper_plat_ci_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(copper_plat_ci_gate_summary(), assert_expected())
